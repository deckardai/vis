...
var ClusterItem = require('./item/ClusterItem');
...
function ItemSet(body, options) {
  ...
  this.defaultOptions = {
    ...
    cluster: false, // TODO PG: option for clustering, false by default
    stack: true,
    stackSubgroups: true,
...
ItemSet.prototype.setOptions = function(options) {
  if (options) {
    ...
    var fields = [
      'type', 'rtl', 'align', 'order', 'stack', 'stackSubgroups', 'cluster', 'selectable', 'multiselect',
    ...
    // TODO PG: add cluster options object once those will be defined
